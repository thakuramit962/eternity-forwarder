    ...
    return (
        <Container sx={{
            ...
            <Typography variant={'h3'}
                        className={'heading  animate__animated animate__fadeInUp'}>{servicesDetails.warehouse?.name}</Typography>

            <Typography variant={'body1'} className={'serviceMainDes  animate__animated animate__fadeInUp'}>
                {servicesDetails.warehouse?.des}
            </Typography>

            <Box className={'serviceParts'}>
                {servicesDetails.warehouse?.subServices.map((service, index) => (
