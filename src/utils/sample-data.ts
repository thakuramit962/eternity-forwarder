...
export const services = [
    {
        ...
        subServices: [
            ...
            {name: 'Drop Ship', link: ''},
            {name: 'Last Mile Delivery', link: ''},
            {name: 'Reverse Logistics', link: ''},
            {name: 'Drone Logistics', link: ''},
            {name: 'Same Day Delivery', link: ''},
        ]
    },
    {
        ...
        subServices: [
            {
                ...
                longDes: 'FTL (Full Truckload) is the ideal transportation solution for businesses with large-scale shipments that require the exclusive use of a full truck. With FTL, your goods will be the only cargo on the truck, ensuring direct delivery from the origin to the destination without any intermediate stops. This service offers several advantages, including faster transit times, reduced handling, and increased security. By utilizing FTL, you gain the benefit of dedicated trucking, allowing for greater control over the transportation process and minimizing the risk of damage or loss. Our FTL services are designed to accommodate your specific requirements, whether it\'s the transport of high-value goods, time-sensitive shipments, or the need for specialized equipment such as temperature-controlled trailers.  \n' +
                    'We prioritize reliability, efficiency, and customer satisfaction, ensuring that your goods are transported safely, securely, and on schedule. Trust our experienced team to provide seamless FTL services that meet your unique logistics needs.\n'
            },

            {
                ...
                ,
                longDes: 'PTL is an efficient and cost-effective transportation solution for businesses that have shipments that are larger than LTL (Less Than Truckload) but do not require a full truckload. With PTL, your shipment shares space with other compatible loads, maximizing the use of available truck capacity and reducing costs. Our PTL services provide the benefits of FTL (Full Truckload) transportation, such as faster transit times, minimized handling, and direct delivery, while offering a more economical option for smaller to medium-sized shipments. By consolidating multiple shipments into a single truck, we optimize efficiency, save costs, and provide reliable transportation solutions for your cargo. Our experienced team ensures careful coordination and secure handling throughout the PTL process, ensuring your goods arrive safely and on time. Whether you have a partial truckload or need to combine shipments with other businesses, our PTL services offer a flexible and cost-efficient logistics solution tailored to your specific needs. '
            },
...
const sampleTracking = [
    {
        "consignment_id": 1147089,
        "status": "Created",
        "create_at": "2023-04-07 12:21:31",
        "type": "2"
    },
    {
        "consignment_id": "1147089",
        "status": "Prs Created",
        "create_at": "2023-04-07 12:21:48",
        "type": "2"
    },
    {
        "consignment_id": "1147089",
        "status": "Hub Transfer",
        "create_at": "2023-04-07 12:28:40",
        "type": "2"
    },
    {
        "consignment_id": "1147089",
        "status": "Received Hub",
        "create_at": "2023-04-07 12:31:45",
        "type": "2"
    },
    {
        "consignment_id": "1147089",
        "status": "Assigned",
        "create_at": "2023-04-07 12:33:00",
        "type": "2"
    },
    {
        "consignment_id": "1147089",
        "status": "Acknowledge",
        "create_at": "2023-04-07 12:35:21",
        "type": "2"
    },
    {
        "consignment_id": "1147089",
        "status": "Started",
        "create_at": "2023-04-07 12:36:02",
        "type": "2"
    },
    {
        "consignment_id": "1147089",
        "status": "Successful",
        "create_at": "2023-04-07 12:38:32",
        "type": "2"
    }
]